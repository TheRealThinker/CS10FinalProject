...
void setup() {
  ...
  raccoon[0] = loadImage("raccoonright");
  raccoon[1] = loadImage("raccoonleft");
  raccoon[2] = loadImage("raccoonattackright");
  raccoon[3] = loadImage("raccooattackleft");
  
  horse[0] = loadImage("horseright");
  horse[1] = loadImage("horseleft");
  horse[2] = loadImage("horseprojectileright");
  horse[3] = loadImage("horseprojectileleft");
